...
EffectManager.prototype._MAX_NUM = 200;
...
ShockWaveEffect.prototype._display = function (surface, x, y) {
    ...
    g.addColorStop(1.00, ShockWaveEffect._OUTER_COLORS[parseInt((this.a * 10).toString())]);
    surface.beginPath();
    surface.fillStyle = g;
...
ExplosionEffect.prototype._PRE_CANVAS = [];
...
ExplosionEffect.prototype.checkLoss = function () {
    return this.count > this._END_COUNT;
};
