...
LogoState.prototype._displayMessage = function (surface) {
    ...
    surface.font = "30px Dengxian";
    surface.textAlign = 'center';
    surface.textBaseAlign = 'middle';
    surface.fillStyle = 'rgb( 255, 255, 255 )';
    surface.fillText('游戏编程技术与实践期末项目', this.opening.getWidth() / 2, 200);
    surface.fillText('Made with WebGL', this.opening.getWidth() / 2, 300);
...
TitleState.prototype._displayMessage = function (surface) {
    ...
    surface.fillText('弹幕魔法使', 120, 200);
    surface.restore();
};
