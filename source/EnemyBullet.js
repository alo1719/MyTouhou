function EnemyBulletManager(gameState, params) {
    ...
    this.reserved = [];
    this._initReserved();
    this.beamDrawer = null;
};
__inherit(EnemyBulletManager, ElementManager);

EnemyBulletManager.prototype._RESERVED_NUM = 50;
EnemyBulletManager.prototype._MAX_NUM = 1000;
...
EnemyBulletDrawer.prototype._doPour = function (e) {
    return (e._ID !== this.elementManager._ID_BEAM);
};
