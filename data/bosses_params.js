            ...
            [
                {
                    ...
                    'v': [
                        {
                            'count': 0,
                            'v': {'r': 0, 'theta': 180, 'w': 0, 'ra': 0, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {
                            'count': 50,
                            'v': {'r': 4, 'theta': 200, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {
                            'count': 200,
                            'v': {'r': 4, 'theta': 160, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {
                            'count': 350,
                            'v': {'r': 4, 'theta': 340, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {
                            'count': 500,
                            'v': {'r': 4, 'theta': 20, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {'count': 600, 'v': 2}
                    ],
                },
            ...
            [
                {
                    ...
                    's': [
                        ...
                        {'bullet': 4, 'type': 3, 'shotCount': [255, 265, 275, 285, 295], 'baseCount': 400},
                        {
                            'bullet': 5,
                            'type': 4,
                            'shotCount': [35, 37, 39, 41, 43, 45, 47, 49, 51, 53],
                            'baseCount': 400
                        },
                        {
                            'bullet': 6,
                            'type': 4,
                            'shotCount': [37, 39, 41, 43, 45, 47, 49, 51, 53, 55],
                            'baseCount': 400
                        },
                        {
                            'bullet': 7,
                            'type': 4,
                            'shotCount': [39, 41, 43, 45, 47, 49, 51, 53, 55, 57],
                            'baseCount': 400
                        },
                    ...
                    'v': [
                        ...
                        {
                            'count': 30,
                            'v': {'r': 3, 'theta': 290, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {
                            'count': 130,
                            'v': {'r': 3, 'theta': 70, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {
                            'count': 230,
                            'v': {'r': 3, 'theta': 250, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {
                            'count': 330,
                            'v': {'r': 3, 'theta': 110, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {'count': 400, 'v': 2}
                    ]
                },
                {
                    ...
                    'v': [
                        {
                            'count': 0,
                            'v': {'r': 0, 'theta': 90, 'w': 0, 'ra': 0, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {
                            'count': 250,
                            'v': {'r': 3, 'theta': 80, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {
                            'count': 500,
                            'v': {'r': 3, 'theta': 240, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {
                            'count': 750,
                            'v': {'r': 3, 'theta': 110, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        ...
                        {
                            'count': 1000,
                            'v': {'r': 3, 'theta': 310, 'w': 0, 'ra': -0.05, 'wa': 0, 'raa': 0, 'rrange': {min: 0}}
                        },
                        {'count': 1250, 'v': 2}
                    ]
                },
            ...
            [
                {
                    ...
                    'v': [
                        ...
                        {
                            'count': 149,
                            'v': {'target': {'x': {'min': 50, 'max': 240}, 'y': {'min': 100, 'max': 200}, 'count': 1}}
                        },
                        {'count': 150, 'v': {'r': 0, 'theta': 90}},
                        {
                            'count': 299,
                            'v': {'target': {'x': {'min': 240, 'max': 430}, 'y': {'min': 100, 'max': 200}, 'count': 1}}
                        },
                        {'count': 300, 'v': {'r': 0, 'theta': 90}},
                        {
                            'count': 449,
                            'v': {'target': {'x': {'min': 190, 'max': 290}, 'y': {'min': 50, 'max': 150}, 'count': 1}}
                        },
                        {'count': 450, 'v': 2}
                    ],
                    'e': {
            ...
            [
                ...
                },
                {
                    ...
                    's': [
                        {'bullet': 18, 'type': 2, 'r': 20, 'shotCount': [0], 'baseCount': 500},
                        {
                            ...
                            'type': 3,
                            'r': 20,
                            'shotCount': [350, 355, 360, 365, 370, 375, 380],
                            'baseCount': 500
                        },
                    ],
                    'v': [
                        ...
                        {
                            'count': 10,
                            'v': {'target': {'x': {'min': 100, 'max': 340}, 'y': {'min': 80, 'max': 120}, 'count': 100}}
                        },
                        {'count': 110, 'v': {'r': 0, 'theta': 90, 'w': 0, 'ra': 0, 'wa': 0}},
                        {
                            'count': 335,
                            'v': {'target': {'x': {'min': 200, 'max': 280}, 'y': {'min': 80, 'max': 120}, 'count': 35}}
                        },
                        ...
                        'shockwave': [
                            {
                                'count': 175,
                                'baseCount': 500,
                                'params': {'w': 10, 'g': 5, 'b': 7, 'a': 0.5, 'endCount': 100}
                            },
                            {
                                'count': 375,
                                'baseCount': 500,
                ...
                },
                {
                    ...
                    'v': [
                        ...
                        {
                            'count': 50,
                            'v': {'target': {'x': {'min': 190, 'max': 290}, 'y': {'min': 80, 'max': 120}, 'count': 100}}
                        },
                        {'count': 150, 'v': 2},
                    ]
                },
