    ...
    __stage1EnemiesParams.push(
        {
            ...
            'v': [
                ...
                {
                    'count': 50,
                    'v': {'r': 2, 'w': 0, 'ra': 0, 'wa': 0.01, 'trange': {'max': 135}, 'wrange': {'max': 0.5}}
                },
            ]
        }
    );
    ...
    __stage1EnemiesParams.push(
        {
            ...
            'v': [
                ...
                {
                    'count': 50,
                    'v': {'r': 2, 'w': 0, 'ra': 0, 'wa': -0.01, 'trange': {'min': 45}, 'wrange': {'min': -0.5}}
                },
            ]
        }
    );
    ...
    __stage1EnemiesParams.push(
        {
            ...
            'v': [
                ...
                {
                    'count': 130 + (i % 2) * 20,
                    'v': {'r': 2, 'theta': 90, 'w': 0, 'ra': 0, 'wa': 0.1, 'trange': {'max': 190}}
                },
            ]
        }
    );
    ...
    __stage1EnemiesParams.push(
        {
            ...
            'v': [
                ...
                {
                    'count': 130 + (i % 2) * 20,
                    'v': {'r': 2, 'theta': 90, 'w': 0, 'ra': 0, 'wa': -0.1, 'trange': {'min': -10}}
                },
            ]
        }
    );
    ...
    __stage1EnemiesParams.push(
        {
            ...
            'v': [
                ...
                {
                    'count': 30,
                    'v': {'r': 2, 'w': 0, 'ra': 0, 'wa': -0.01, 'trange': {'min': -30}, 'wrange': {'min': -1}}
                },
            ]
        }
    );
...
for (var i = 0; i < 20; i++) {
    __stage1EnemiesParams.push(
        {
            'count': 1700 + parseInt((i / 2).toString()) * 10,
            'x': (i % 2 === 0 ? 50 : 80) + i * 10,
            'vital': 1,
            'powerItem': i % 4 === 0 ? 1 : 0,
            'scoreItem': i % 4 === 2 ? 1 : 0,
            'v': [
                ...
                {
                    'count': 30,
                    'v': {'r': 3, 'w': 0, 'ra': 0, 'wa': -0.02, 'trange': {'min': -45}, 'wrange': {'min': -1}}
                },
...
for (var i = 0; i < 20; i++) {
    __stage1EnemiesParams.push(
        {
            'count': 1900 + parseInt((i / 2).toString()) * 10,
            ...
            'v': [
                ...
                {
                    'count': 180,
                    'v': {'r': 3, 'w': 0, 'ra': 0, 'wa': -0.02, 'trange': {'min': 135}, 'wrange': {'min': -1}}
                },
            ]
        }
    );
...
for (var i = 0; i < 100; i++) {
    __stage2EnemiesParams.push(
        {
            'count': 100 + i * 5,
            'x': parseInt((__randomizer.random() * 480).toString()),
            'vital': 1,
            'powerItem': i % 2 === 0 ? 1 : 0,
            'scoreItem': i % 2 === 1 ? 1 : 0,
